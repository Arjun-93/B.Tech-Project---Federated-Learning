...
#     with open('C:\\Users\\intel\\Desktop\\Arjun Workspace\\B.Tech-Project---Federated-Learning\\Project_file\\models\\accuracy1.txt', 'a') as file:
#                 file.write(str(training_accuracy)+'\n')
#     with open('C:\\Users\\intel\\Desktop\\Arjun Workspace\\B.Tech-Project---Federated-Learning\\Project_file\\models\\server1.txt', 'w') as file:
...
def check(n_features):
    model = LogisticRegression(n_features)
    file_path = 'C:\\Users\\intel\\OneDrive\\Desktop\\Arjun Workspace\\B.Tech-Project---Federated-Learning\\Project_file\\models\\average.txt'
    if os.path.getsize(file_path) == 0:
        return model
    else:
        data_string = read_file(file_path)
...
def function():
    ...
    with open('Project_file\\models\\server1.txt', 'w') as file:
            file.write(param_str)
    with open('Project_file\\models\\accuracy1.txt', 'a') as file:
            file.write(str(training_accuracy) + "\n")
    return param_str
