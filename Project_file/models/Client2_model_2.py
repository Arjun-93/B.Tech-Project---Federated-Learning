...
def check(n_features):
    ...
    file_path = 'Project_file\\models\\average.txt'
...
def function():
    ...
    with open('Project_file\\models\\accuracy2.txt', 'a') as file:
                file.write(str(training_accuracy)+'\n')
    with open('Project_file\\models\\Client2_model_2.txt', 'w') as file:
